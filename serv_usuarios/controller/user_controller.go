...
var (
	userService = service.NewUserServiceImpl(
		client.NewUserClient(config.DBUSER, config.DBPASS, config.DBHOST, config.DBPORT, config.DBNAME),
		client.NewQueueClient(config.RABBITUSER, config.RABBITPASSWORD, config.DBHOST, config.RABBITPORT),
	)
)
*/
